...
const char *ssid = "ESP32RPLidarA1"; // configure WiFi SSID
const char *password = "esp32lidar"; // configure WiFi password

const char *udp_send_address = "192.168.4.255"; // configure the subnet-mask
const int udp_port = 3333;                      // configure the port on which UDP should be sent and received
...
{
  int pin = (lds_pin == LDS::LDS_MOTOR_EN_PIN) ? LDS_MOTOR_EN_PIN : LDS_MOTOR_PWM_PIN;
